				...
				<table border="1" width="100%" height="100%">
					<tr>
						<td rowspan=1 width="5px" height="5px">送信者：
							<input type = "text" size="86" value = "トレーニ">
						</td>
					</tr>
					<tr>
						<td rowspan=1 width="5px" height="5px">宛先：
							<input type = "text"size = "89" value = "CSS_2016trainer@central-soft.co.jp">
						</td>
					</tr>
					<tr>
						<td rowspan=1 height="5px">件名：
							<input type = "text"size = "89" value = "【日報】トレーニ → トレーナ 6/1 6">
						</td>
					</tr>
					<tr>
						<td>
...
TEL：03-5822-0601
FAX：03-5822-0604
URL：http://www.central-soft.co.jp
							</textarea>
						</td>
					</tr>
				</table>
